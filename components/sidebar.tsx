...
export default function Sidebar() {
    ...
    return (
        <>
            ...
            <div className="lg:hidden fixed bottom-4 left-4 z-50">
                <button
                    ...
                    className="w-12 h-12 bg-teal-600 text-white rounded-full shadow-lg flex items-center justify-center hover:bg-teal-700 transition"
                >
                    <Icon name={isMobileOpen ? 'close' : 'menu'} size={20} />
                </button>
            </div>
            ...
            {/* Sidebar */}
            <aside className={`
        w-64 bg-white border-r border-gray-100 h-screen flex flex-col shrink-0 overflow-y-auto
      ...
      `}>
                ...
                {/* Global Command Center launcher (⌘K) - Hidden on mobile */}
                <div className="hidden sm:block px-3 mb-4 shrink-0">
                    <button
                        onClick={openCommand}
