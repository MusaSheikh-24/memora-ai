                    ...
                    <div className="space-y-6 max-w-md">
                        <div>
                            ...
                            <p className="text-teal-100 text-lg">
                                Join 50,000+ teams working smarter with AI-powered knowledge.
                            </p>
                        </div>

                        {/* Features */}
                        <div className="space-y-3 pt-2">
                            {['No credit card required', '14-day free trial', 'Setup in 2 minutes'].map((feature, i) => (
                    ...
                    <form onSubmit={handleSubmit} className="space-y-3.5">
                        ...
                        <div className="flex items-start gap-2 pt-1">
                            <input
                                ...
                                type="checkbox"
                                required
                                className="mt-0.5 w-4 h-4 border-2 border-gray-300 rounded focus:border-teal-500 focus:ring-4 focus:ring-teal-500/10 transition-all text-teal-600"
                            />
